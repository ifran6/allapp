           ...
           <td>".$n++."</td>"."
            ...
            <td>" ?>
                <div class='btn-group d-flex'>
                    ...
                    <a href="./add_product.php" class='btn btn-sm btn-dark mx-2  p-2 button_add_post w-50' > Add Post</a>

                    <button class="btn btn-sm btn-danger btn_delete-product w-50" name="delete-post" id="delete_post" data-id="<?=$row['id']?>"> Delete</button>
                 </div>
           <?php echo "</td>
            </tr>";
